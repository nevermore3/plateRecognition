...
class PlateLocate(object):
    ...
    def sobelSecSearchPart(self, bound, refpoint, out):
        ...
        contours, _ = cv2.findContours(bound_threshold, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)
        for it in contours:
    ...
    def sobelFrtSearch(self, src):
        ...
        contours, _ = cv2.findContours(src_threshold, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)
